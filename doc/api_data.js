define({ "api": [
  {
    "type": "get",
    "url": "HOST/class/activity/set-score",
    "title": "Set Activity Score",
    "version": "1.0.0",
    "name": "SetActivityScore",
    "description": "<p>Set activity score of a student.</p>",
    "group": "Activities",
    "parameter": {
      "fields": {
        "Parameter": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "class_id",
            "description": "<p>filter the list to return published assignments to the class.<br> OPTIONAL for teacher; and if not specified, returns all the periodicals created by teacher<br><br> REQUIRED for students.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "class_id",
            "description": "<p>filter the list to return published periodicals to the class.<br> OPTIONAL for teacher; and if not specified, returns all the periodicals created by teacher<br><br> REQUIRED for students.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "class_id",
            "description": "<p>filter the list to return published quizzes to the class.<br> OPTIONAL for teacher; and if not specified, returns all the quizzes created by teacher<br><br> REQUIRED for students.</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
